...
const PhoneInput = memo(function PhoneInput({ value, onChange, hasError }: PhoneInputProps) {
    return (
        <div
        ...
        >
            ...
            />
            <span className="text-white/50 text-sm sm:text-base font-manrope">+91</span>
            <input
                name="contact"
