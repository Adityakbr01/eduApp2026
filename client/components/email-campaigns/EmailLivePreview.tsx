...
export function EmailLivePreview({
    ...
    previewText,
    fromName = "EduApp",
    fromEmail = "noreply@eduapp.com",
    className,
}: EmailLivePreviewProps) {
    const [deviceView, setDeviceView] = useState<DeviceView>("desktop");
    const [showRaw, setShowRaw] = useState(false);

    // Sanitize but allow basic HTML
    ...
    return (
        <div className={cn("space-y-4", className)}>
            ...
            <div className="flex justify-center bg-gray-100 dark:bg-gray-900 rounded-lg p-4 min-h-[500px] overflow-auto">
                <div className={cn(
                    ...
                    {showRaw ? (
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
                            {/* Email Client Header */}
                            <div className="bg-gray-50 dark:bg-gray-700 border-b px-4 py-3">
                            ...
                            <div className="px-6 py-6">
                                {content ? (
                                    ...
                                    <div className="text-center py-12 text-muted-foreground">
                                        ...
                                        <p className="text-sm mt-1">Start typing or use AI to generate content</p>
                                    </div>
                                )}
                            </div>

                            {/* Email Footer */}
                            <div className="border-t bg-gray-50 dark:bg-gray-700/50 px-6 py-4">
                                <p className="text-xs text-muted-foreground text-center">
                                    This is a preview. Actual email may appear slightly different depending on the email client.
                                </p>
                            </div>
                        </div>
                    )}
