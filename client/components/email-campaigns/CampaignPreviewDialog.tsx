...
export function CampaignPreviewDialog({
    ...
    const { data, isLoading } = useGetCampaign(campaignId || "", !!campaignId && open);
            ...
            <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                ...
                {isLoading ? (
                    ...
                    <div className="space-y-6">
                        ...
                        {/* Email Preview */}
                        <div>
                            <h3 className="text-sm font-medium mb-3">Email Content Preview</h3>
                            <div className="rounded-lg border bg-white p-6">
                                {/* Email Header */}
                                <div className="mb-4 pb-4 border-b">
                                    <div className="text-sm text-muted-foreground mb-1">From: EduApp Marketing</div>
                                    <div className="text-sm text-muted-foreground mb-1">To: Recipients</div>
                                    <div className="font-semibold text-lg mt-2">{campaign.subject}</div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-yellow-700 mt-1">
                                            Only users who have opted into marketing emails will receive this campaign.
                                            Users who have not verified their email will also be excluded.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        <div className="text-2xl font-bold">
                                            {campaign.metadata.actualRecipients || campaign.metadata.estimatedRecipients}
                                        </div>
