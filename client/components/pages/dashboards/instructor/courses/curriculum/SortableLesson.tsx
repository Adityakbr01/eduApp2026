...
export function SortableLesson({ lesson, index, sectionId, courseId }: SortableLessonProps) {
    const [isOpen, setIsOpen] = useState(false);
    const [editDialogOpen, setEditDialogOpen] = useState(false);
    const [deleteDialogOpen, setDeleteDialogOpen] = useState(false);
    const [contentDialogOpen, setContentDialogOpen] = useState(false);
    const [localContents, setLocalContents] = useState<ILessonContent[] | null>(null);
    ...
    const handleUpdateLesson = async (data: { title: string; description?: string }) => {
        try {
            ...
            <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Are you sure you want to delete &quot;{lesson.title}&quot;? This will also delete all content within this lesson. This action cannot be undone.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
