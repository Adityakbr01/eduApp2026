...
export function CourseForm({
  ...
  const [draftId] = useState(() => initialData?._id ?? uuidv4());
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            {isEditing && (
              <Link
                href={`/dashboard/Instructor/courses/${initialData?._id}/curriculum`}
                    ...
                    <FormItem>
                      <FormControl>
                        <CourseImageUploader
                          ...
                          value={field.value}
                          onChange={(s3Key) => {
                            field.onChange(s3Key); // 🔥 saved in form
                          }}
                        />
                      </FormControl>
              ...
              <CardContent className="space-y-4">
                ...
                {!form.watch("pricing.isFree") && (
                  <>
                    ...
                    {(() => {
                      const originalPrice =
                        form.watch("pricing.originalPrice") || 0;
                      const discountPercentage =
                        form.watch("pricing.discountPercentage") || 0;
                      const discountExpiresAt = form.watch(
