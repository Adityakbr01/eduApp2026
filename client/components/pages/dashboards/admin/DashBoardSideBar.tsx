...
function DashBoardSideBar({ setActiveSection, activeSection, logout, isOpen, onClose }: Props) {
    const handleNavClick = (value: (typeof adminUtils.sidebarItems)[number]['value']) => {
