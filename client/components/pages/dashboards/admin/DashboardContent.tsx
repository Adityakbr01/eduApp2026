...
import { ActivityFeedItem, adminUtils, BanSummary, CourseInsight, PermissionKey, RecentUserItem, RolePermission } from '../common/utils'
...
interface DashboardContentProps {
    ...
    stats: { label: string; value: string; trend: string; bgColor: string; border: string }[];
    ...
    handleTogglePermission: (role: string, permissionKey: PermissionKey, checked: boolean) => void;
}
...
function DashboardContent({
    ...
    return (
        <main className="flex-1 flex flex-col h-screen overflow-hidden">
            <DashBoardHeader sectionTitle={activeSectionItem.label} activeSection={activeSectionItem} searchQuery={searchQuery} setSearchQuery={setSearchQuery} />
