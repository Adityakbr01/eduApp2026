...
import NewInstructorForm from "../form/NewInstructorForm";
...
function InstructorSignUpPage() {
    ...
    return (
        <div className="w-full relative z-20 overflow-hidden  min-h-screen flex items-center justify-center p-0">
            ...
            <div ref={smoke1Ref} className="fluid-container absolute z-10 bg-[#1b80ed91] h-[90vh] w-[90vh] rounded-full -top-[50vh] -right-[90vh] blur-[40vh]">
            </div>
