...
function EnrollmentCard({
    ...
    console.log("EnrollmentCard - Course:", course, visibleSections, totalLessons, totalDuration);
    ...
    const { data: enrollmentData, isLoading: isCheckingEnrollment } = useCheckEnrollmentStatus(
        course._id,
        isLoggedIn && hydrated
    );
    ...
    // Loading states
    const isLoading = enrollInFreeCourse.isPending || isPaymentLoading || (!hydrated);
    const isButtonDisabled = isLoading || isCheckingEnrollment;
