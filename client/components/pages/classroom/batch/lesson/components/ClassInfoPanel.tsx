...
import StatusIcon from "@/components/Batch/Modules/StatusIcon";
import { ContentDetailResponse } from "@/services/classroom/batch-types";
  ...
  return (
    <div className="h-full">
      ...
      <div className="h-16 absolute right-5 z-10 flex items-center justify-end">
        <button className="text-dark-light hover:brightness-150">
          <Maximize size={20} />
        </button>
      </div>
      ...
      <div className="bg-dark-card rounded-2xl flex flex-col overflow-y-auto h-full w-full border border-white/5 text-white/80">
        ...
        <div className="flex items-center gap-2 pe-12 w-full shadow-md shadow-black/5 h-16 shrink-0 px-6 text-xl text-white/80 bg-dark-extra-light pl-5 pr-5">
          <div className="flex items-center gap-3 text-xl ml-2">
            <div className="border-2 border-accent rounded-full p-0.5 w-5.5 h-5.5 flex items-center justify-center">
              <Play size={12} className="text-accent ms-0.5" strokeWidth={3} />
            </div>
