      ...
      {podiumItems.map((user, idx) => {
        ...
        return (
          ...
          >
            ...
            <div
              className={`w-20 sm:w-28 md:w-32 ${style.height} bg-linear-to-b ${style.gradientFrom} ${style.gradientTo} rounded-t-2xl flex flex-col justify-between items-center py-3 sm:py-4 text-white shadow-2xl ${style.glowColor} relative overflow-hidden group-hover:shadow-3xl transition-all duration-300`}
            >
              {/* Shine effect */}
