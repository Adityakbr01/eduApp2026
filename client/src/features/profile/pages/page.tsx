...
import ProfileBasicTab from "@/features/profile/components/ProfileBasicTab";
import ProfileProfessionalTab from "@/features/profile/components/ProfileProfessionalTab";
import ProfileBatchesTab from "@/features/profile/components/ProfileBatchesTab";
import ProfileProjectsTab from "@/features/profile/components/ProfileProjectsTab";
...
export default function ProfilePage() {
  ...
  return (
    <div className="flex md:px-6 pb-48 lg:px-10 flex-col lg:flex-row gap-6 lg:gap-8 pt-10 min-h-[calc(100vh-100px)]">
      {/* Sidebar */}
      <div className="w-full lg:w-[280px] shrink-0 lg:sticky lg:top-24 h-fit">
