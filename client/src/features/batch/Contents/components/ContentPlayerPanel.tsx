...
import AssignmentPlayer from "@/features/batch/Contents/components/AssignmentPlayer";
import QuizPlayer from "@/features/batch/Contents/components/QuizPlayer";
import VdoCipherPlayer from "@/features/batch/Contents/components/VdoCipherPlayer";
import {
  AssignmentData,
  ...
  return (
    <div className="h-full w-full">
      <div className="bg-dark-card rounded-2xl flex flex-col h-full w-full border border-white/5 text-white/80 overflow-hidden">
        ...
        {activeContentMeta?.type !== "quiz" && (
          <div className="flex items-center w-full shadow-md shadow-black/5 shrink-0 px-3 sm:px-5 h-12 sm:h-14 text-base sm:text-xl text-white/80 bg-dark-extra-light justify-between z-10">
