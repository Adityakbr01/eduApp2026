...
export function CourseDetailPage({ slug }: CourseDetailPageProps) {
  ...
  const {
    ...
    isLoading,
    error,
  } = useGetPublishedCourseById(slug);
  ...
  const visibleSections =
    course.sections?.filter((s: { isVisible: boolean }) => s.isVisible) || [];
        ...
        <div className="grid lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Button
              ...
              className="hover:bg-transparent hover:text-foreground group cursor-pointer"
            >
