...
router.get("/getAllRoleANDPermission", checkRole(ROLES.ADMIN.code, ROLES.MANAGER.code, ROLES.INSTRUCTOR.code), userController.getAllRoleANDPermission);
...
// //@desc APPROVE USER,  
router.post("/approved-user/:id", checkRole(ROLES.ADMIN.code, ROLES.MANAGER.code, ROLES.INSTRUCTOR.code), checkPermission(PERMISSIONS.MANAGE_USER.code), userController.approveUser);
// //@ban USER ,  
router.post("/user-ban-unban/:id", checkRole(ROLES.ADMIN.code, ROLES.MANAGER.code, ROLES.INSTRUCTOR.code), checkPermission(PERMISSIONS.MANAGE_USER.code), userController.toggleUserStatus);
